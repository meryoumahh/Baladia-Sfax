...
from .views import UserInfoView , AgentCreateView, UserLoginView, UserLogoutView, CookieTokenRefreshView,CitoyenSignupView, UserSignupView, AgentListView,CitoyenListView
urlpatterns = [
